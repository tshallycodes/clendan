...
| MCP Name | What It Does | Relevant To | URL | Stars | Cost |
|---|---|---|---|---|---|
| **PDF Reader** (parallel) | Accelerates PDF processing: extracts text, images, metadata with parallel execution and precise content ordering | Invoice Parser API — high-throughput invoice PDF ingestion | https://mcpmarket.com/search?q=pdf | ⭐ 717 | Free/OSS |
| **PDF Reader** (secure) | Securely reads and extracts text, metadata, and page counts from PDF files (local or URL) | Invoice Parser API — secure PDF handling for tenant files | https://mcpmarket.com/search?q=pdf | ⭐ 303 | Free/OSS |
| **PDF** (AI caching) | Efficiently extracts text, searches, and analyses PDF documents using intelligent caching | Invoice Parser API — caching for repeated supplier invoice formats | https://mcpmarket.com/search?q=pdf | ⭐ 38 | Free/OSS |
| **PDFlow** | Transforms PDFs into structured data using AI-powered extraction | Invoice Parser API — structured JSON from invoice PDFs | https://mcpmarket.com/search?q=pdf | – | Free/OSS |
| **PDF.co** | Automates comprehensive PDF manipulation, conversion, OCR, and text extraction via the PDF.co API | Receipt OCR API — OCR pipeline for receipts and invoices | https://mcpmarket.com/search?q=pdf | – | Paid |
| **Pdf Tools** | Merge, extract pages, and search content in PDFs | Contract Data Extraction API — manipulating contract PDFs | https://mcpmarket.com/search?q=pdf | ⭐ 74 | Free/OSS |
| **OCR Document Intelligence** | Intelligently reads and processes both scanned and digital PDF documents with integrated OCR and robust caching | Receipt OCR + Policy Check API — scanned receipt handling | https://mcpmarket.com/search?q=ocr | – | Free/OSS |
| **Textin** | Text extraction and OCR including explicit invoice recognition capability | Invoice Parser API — dedicated invoice OCR | https://mcpmarket.com/search?q=ocr | ⭐ 28 | Free/OSS |
| **OCR** (state-of-art) | Advanced OCR with state-of-the-art models, WIA scanner control, multi-format document processing | Receipt OCR API — high-accuracy multi-format OCR | https://mcpmarket.com/search?q=ocr | ⭐ 14 | Free/OSS |
| **Tesseract** | Integrates Tesseract OCR as an MCP server for text extraction from images and PDFs | Receipt OCR API — self-hosted, no API costs | https://mcpmarket.com/search?q=ocr | – | Free/OSS |
| **Google Vision** | Advanced OCR via Google Cloud Vision API | Receipt OCR API — high-accuracy fallback for poor image quality | https://mcpmarket.com/search?q=ocr | – | Paid |
| **ParseFlow** | Comprehensive document parsing: office formats, OCR, and AI-driven semantic search | Contract Data Extraction API — multi-format contract parsing | https://mcpmarket.com/search?q=ocr | – | Free/OSS |
| **DocMistral** | Converts documents and images into Markdown using Mistral AI's OCR | Contract Data Extraction API — alternative OCR model | https://mcpmarket.com/search?q=ocr | – | Free/OSS |
| **Invoice Parser** (Claude Vision) | Extracts structured JSON from invoices and receipts using Claude Vision — designed for AI agents | Invoice Parser API — Claude-native extraction pipeline | https://mcpmarket.com/search?q=invoice | – | Free/OSS |
...
| **Pg-Mcp** | Exposes PostgreSQL databases to AI agents via MCP, with rich schema discovery and query capabilities | AI agent direct DB access for reconciliation queries | https://mcpmarket.com/search?q=posthog | ⭐ 538 | Free/OSS |
...
| MCP Name | What It Does | Relevant To | URL | Stars | Cost |
|---|---|---|---|---|---|
| **GitHub** (official) | Advanced automation and interaction with GitHub APIs via MCP — most popular on the platform | CI/CD pipeline management, code review, issue tracking for Clendan development | https://mcpmarket.com/search?q=github | ⭐ 30k | Free/OSS |
| **Vercel Integration** | Integrates Vercel's REST API as tools within MCP for programmatic deployment management | Frontend deployment management — control plane dashboard on Vercel | https://mcpmarket.com/search?q=vercel | ⭐ 67 | Free/OSS |
| **Vercel** (admin control) | Full administrative control over Vercel deployments via Cursor/Codeium | Managing Clendan's Next.js frontend deployment | https://mcpmarket.com/search?q=vercel | ⭐ 61 | Free/OSS |
| **Vercel Adapter** | Real-time communication between Next.js applications and AI models via MCP adapter | MCP integration layer for Clendan's Next.js control plane | https://mcpmarket.com/search?q=vercel | ⭐ 341 | Free/OSS |
| **Context7** | Fetches up-to-date documentation and code examples for LLMs from the source | Development — keeping AI coding tools accurate on Anthropic SDK, FastAPI, Next.js | https://mcpmarket.com/server/context7-1 | ⭐ 55.7k | Free/OSS |
...
7. **OCR Document Intelligence** — Handles both scanned and digital PDFs with OCR + caching. Critical for the Receipt OCR + Policy Check API — many expense receipts arrive as photos, not clean PDFs.
...
*Sourced from mcpmarket.com — 34,189 servers indexed as of 2026-05-21.*