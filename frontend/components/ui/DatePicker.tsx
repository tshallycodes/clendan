  ...
  return (
    <div ref={ref} className={`relative ${className ?? ''}`}>
      <button
        type="button"
        onClick={() => setOpen(v => !v)}
        className="flex items-center gap-2 bg-brand-bg border border-brand-border rounded-sm text-brand-text px-3 py-2 text-xs font-mono focus:outline-none focus:border-[#00C853] w-full hover:bg-brand-elevated transition-colors"
      >
