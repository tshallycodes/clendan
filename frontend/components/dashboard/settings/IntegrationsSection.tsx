          ...
          <div key={slug} className="bg-brand-surface px-4 py-4 flex items-start gap-4">
            <div className="flex-1 min-w-0 space-y-1.5">
              <div className="flex items-center gap-3">
                ...
                {providerLabel && (
                  <span className="text-[11px] font-body text-brand-muted">via {providerLabel}</span>
                )}
                <span className={[
                  'text-[11px] font-body px-2 py-0.5 rounded-sm border',
                  isSyncing
              ...
              {meta.desc && (
                <p className="text-[11px] font-body text-brand-muted">{meta.desc}</p>
              )}
              {connected_at && (
              ...
              {confirmSlug === slug ? (
                <>
                  <button
                    ...
                    className="text-[11px] font-body text-[#ff4d6d] border border-[#ff4d6d]/30 bg-[rgba(255,77,109,0.08)] hover:bg-[rgba(255,77,109,0.15)] rounded-sm px-2 py-1 transition-colors disabled:opacity-50"
                  >
        ...
        <div className="flex items-center gap-2">
          {connected.some((i) => i.status === 'syncing') && (
            <button
              ...
              className="text-[11px] font-body text-[#f5a623] border border-[#f5a623]/30 bg-[rgba(245,166,35,0.08)] hover:bg-[rgba(245,166,35,0.12)] rounded-sm px-2 py-1 transition-colors disabled:opacity-50"
            >
