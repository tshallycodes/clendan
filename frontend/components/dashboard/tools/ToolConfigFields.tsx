...
const WORKER_FIELDS: Record<string, FieldDef[]> = {
  ...
  reconciliation: [
    ...
    { key: 'amount_tolerance_pct', type: 'number', label: 'Bank · Amount tolerance (fraction)', unit: 'e.g. 0.003', step: 0.0001, min: 0, max: 0.01, default: 0.0003,
      description: 'Fractional amount difference allowed on top of the fixed tolerance. Stored as a decimal — 0.003 = 0.3%, 0.0003 = 0.03%. Applied after the pence tolerance above.' },
    ...
    { key: 'auto_match_confidence_min', type: 'number', label: 'Bank · Auto-match min confidence', unit: '0.0–1.0', step: 0.01, min: 0, max: 1, default: 0.95,
      description: 'Claude must reach at least this confidence to auto-match without human review. 0.95 = 95% certainty required. Below this the match is queued for approval.' },
    ...
    { key: 'run_hour_utc', type: 'number', label: 'Schedule · Run at hour', unit: '0–23', min: 0, max: 23, default: 2,
