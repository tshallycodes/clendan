  ...
  return (
    <div className="bg-brand-bg text-brand-text">
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-8 pt-20 pb-12">
        <p className="font-mono text-[10px] uppercase tracking-widest text-brand-muted mb-4">Workers</p>
        <h1
        ...
        <p className="font-mono text-sm text-brand-secondary max-w-xl">
          Each worker is a specialised sub-agent with a defined role, tools, and policy rules.
      ...
      <section className="border-t border-brand-border">
        <div className="max-w-6xl mx-auto px-6 md:px-8 py-20 text-center">
          <h2
            ...
            style={{ fontFamily: 'var(--font-heading)' }}
          >
            Start with the Invoice Processing Worker
          </h2>
          <p className="font-mono text-sm text-brand-secondary mb-8">
            The most deployed worker in Clendan. Live in under 10 minutes.
          </p>
          <Link
            href="/sign-up"
          ...
          >
            Deploy Invoice Processing Worker →
          </Link>
        </div>
      </section>
