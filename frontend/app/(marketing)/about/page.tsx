  ...
  return (
    <div className="bg-brand-surface border border-brand-border rounded-sm p-6 flex flex-col gap-4">
      ...
      <div>
        ...
        <p className="font-body text-[13px] text-brand-secondary mt-0.5">{role}</p>
      </div>
      <a
        ...
        className="font-body text-[12px] text-brand-muted hover:text-brand-secondary transition-colors flex items-center gap-1.5"
      >
        <LinkedInIcon />
        LinkedIn
      </a>
    ...
    <div className="flex items-start gap-4">
      <div className="flex flex-col items-center">
        <div className="w-8 h-8 rounded-sm bg-[rgba(0,200,83,0.08)] border border-[rgba(0,200,83,0.2)] flex items-center justify-center flex-shrink-0">
          <span className="font-body text-brand-green text-[11px] font-medium">{phase}</span>
        </div>
        {!isLast && (
