                  ...
                  <section>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 py-2 text-[12px] font-body text-brand-text border border-brand-border rounded-sm hover:bg-brand-bg transition-colors disabled:opacity-60"
                      >
                        {resyncing ? 'Syncing...' : 'Resync'}
                      </button>
                      <button onClick={onSyncLog} className="flex-1 py-2 text-[12px] font-body text-brand-text border border-brand-border rounded-sm hover:bg-brand-bg transition-colors">Sync Log</button>
                      {confirmDisconnect ? (
                        <>
                          <button
                          ...
                          <button onClick={() => setConfirmDisconnect(false)} className="px-3 py-2 text-[12px] font-body text-brand-muted border border-brand-border rounded-sm hover:bg-brand-bg transition-colors">Cancel</button>
                        </>
                      ) : (
