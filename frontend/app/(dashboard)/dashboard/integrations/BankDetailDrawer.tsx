    ...
    <div className="bg-brand-bg border border-brand-border rounded-sm overflow-hidden" style={{ borderLeft: '3px solid #00C853' }}>
      ...
      <div className="px-4 py-3 flex gap-2">
        <button
          ...
          className="flex-1 py-1.5 text-[11px] font-body text-brand-text bg-transparent border border-brand-border rounded-sm hover:bg-brand-bg transition-colors disabled:opacity-60"
        >
        ...
        <button
          ...
          className="flex-1 py-1.5 text-[11px] font-body text-brand-text bg-transparent border border-brand-border rounded-sm hover:bg-brand-bg transition-colors"
        >
          Sync Log
        </button>
        {confirmDisconnect ? (
          <>
            ...
            <button
              ...
              className="px-3 py-1.5 text-[11px] font-body text-brand-muted bg-transparent border border-brand-border rounded-sm hover:bg-brand-bg transition-colors"
            >
              Cancel
            </button>
          </>
