    ...
    <AnimatedPage className="p-6 space-y-8">
      ...
      <AnimatedSection>
        <div>
          ...
          <p className="text-brand-muted text-xs font-mono mt-1">Manage your organisation, team, and credentials</p>
        </div>
      </AnimatedSection>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  {data ? <OrgNameForm initialName={data.tenant.name} /> : <p className="text-xs font-mono text-brand-muted">Backend unavailable</p>}
                </div>
                <div>
          ...
          <AnimatedSection>
            <section className="space-y-4">
              <div className="border-b border-brand-border pb-2 flex items-baseline justify-between">
                ...
                <p className="text-[10px] font-mono text-brand-muted">Connected external systems</p>
              </div>
              <IntegrationsSection />
            </section>
          </AnimatedSection>
