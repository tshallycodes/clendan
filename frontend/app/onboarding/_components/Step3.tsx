  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-1">
        ...
        <p className="text-xs font-mono text-brand-muted">Link a system to enable automatic financial sync.</p>
      </div>
      <div className="space-y-3">
        ...
        <div className="relative bg-brand-surface border border-brand-border rounded-sm p-5 opacity-50">
          <div>
            <p className="text-sm font-mono text-brand-text font-medium">Plaid</p>
            <p className="text-[10px] font-mono text-brand-muted mt-0.5">
          ...
          <div className="mt-3">
            <span
              ...
              className="inline-flex cursor-not-allowed border border-brand-border text-brand-muted rounded-sm px-4 py-2 text-xs font-mono"
            >
              Connect Plaid
            </span>
          </div>
