  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-1">
        ...
        <p className="text-xs font-mono text-brand-muted">Invoice Processing Worker is ready to deploy.</p>
      </div>
      <div className="bg-brand-surface border-l-[3px] border-l-brand-green border border-brand-border rounded-sm p-4">
        <p className="text-sm font-mono text-brand-text font-medium">Invoice Processing Worker</p>
