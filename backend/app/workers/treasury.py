"""
Treasury Worker — sub-agent worker. Called by Financial Orchestrator as a tool.
...
async def run_treasury_job(
    ...
    *,
    ...
    try:
        result = await _execute_treasury(tenant_id, worker_id, execution_id)
