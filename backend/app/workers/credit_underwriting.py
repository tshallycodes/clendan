"""
Credit Underwriting Worker — sub-agent worker. Called by Financial Orchestrator as a tool.
...
_ACTOR = "worker:credit_underwriting:v1"
...
async def _execute_credit_underwriting(
    ...
    # Fetch and validate worker config
    ...
    *,
    ...
    try:
        result = await _execute_credit_underwriting(
            tenant_id, worker_id, execution_id, application_data
        )
