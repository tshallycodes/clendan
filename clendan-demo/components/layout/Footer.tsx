      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-brand-muted text-xs font-mono leading-relaxed">
              AI execution infrastructure for autonomous finance operations.
            </p>
            <div className="flex gap-3 mt-4">
              <Link href="#" className="text-brand-muted hover:text-brand-text transition-colors" aria-label="GitHub">
              ...
              <Link href="#" className="text-brand-muted hover:text-brand-text transition-colors" aria-label="LinkedIn">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </Link>
              <Link href="#" className="text-brand-muted hover:text-brand-text transition-colors" aria-label="X / Twitter">
          ...
          {Object.entries(FOOTER_LINKS).map(([category, links]) => (
            <div key={category}>
              <h4 className="text-[10px] font-mono text-brand-muted uppercase tracking-widest mb-3">
                {category}
              </h4>
        ...
        <div className="mt-12 pt-6 border-t border-brand-border flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-brand-muted text-xs font-mono">
            © 2026 Clendan. All rights reserved.
          </p>
          <p className="text-brand-muted text-xs font-mono">
